...
installTemplate() {
    ...
    wget https://raw.githubusercontent.com/ParkStable/xrayr-proxy/main/html_template.tar
...
#    echo -e "  ${GREEN}17.${PLAIN}  查看V2ray日志"
    ...
    echo "================================"
    echo ""
    echo -e "  ${GREEN}1.${PLAIN}   为XrayR添加nginx反代"
...
#    sed -i 's/CertMode: \(file\|http\|dns\)/CertMode: none/g' /etc/XrayR/config.yml
	...
	colorEcho $GREEN "-----------v2board/xboard节点配置-----------------------------"
